...
<title>Consulta estoque de Produtos</title>
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="consulta.jsp">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<main role="main" class="container">
  ...
  <div class= container>
	<h1>Olá seja bem-vindo!</h1>
	  ...
	  <h1 class="h3 mb-3 font-weight-normal">Digite o produto que deseja cadastrar</h1>
